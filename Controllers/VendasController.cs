...
namespace proveiMvc.Controllers
{
    public class VendasController : Controller
    {
        ...
        {
            // Adiciona o nome do produto ao SelectList para ProdutoId
        ...
        public async Task<IActionResult> Create([Bind("Id,DataEmissao,ValorTotal,ClienteId,ProdutoId")] Venda venda)
        {
            ...
            // Recarrega os SelectLists caso o ModelState não seja válido
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Nome,Descricao,Preco,Estoque")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
        ...
        // Método privado para verificar existência (similar ao VendaExists)
